  ...
  return (
    <Grid2 container spacing={2} sx={{ marginBottom: "10px"}} justifyContent="space-between">
      <Grid2 display="flex" flexDirection="column" alignItems="center">
        <CustomButton iconGap={8} icon={ArrowLeft}>Предыдущая страница</CustomButton>
      ...
      <Grid2 display="flex" flexDirection="column" alignItems="center">
        <CustomButton iconGap={8} icon={ArrowRight} direction={ButtonDirection.Right}>Следующая страница</CustomButton>
        <div className={s.productCode}>Vendor код: 29873465876</div>
      </Grid2>
    </Grid2>
  );
